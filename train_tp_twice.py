...
print('Epochs = ', epochs)
expname = 'TP_twice_' + str(Hlayers) + 'Hlayers-' + str(Olayers) + 'Olayers-' + str(epochs) + 'epochs-' + Hactivation + '-' + Oactivation
...
X_train_file = os.path.join(path, 'X_tp_twice_train.hdf')
X_train = pd.read_hdf(X_train_file)

print('Reading X_test')
X_test_file = os.path.join(path, 'X_tp_twice_test.hdf')
X_test = pd.read_hdf(X_test_file)

print('Reading y_train')
y_train_file = os.path.join(path, 'y_lichen_twice_train.hdf')
y_train = pd.read_hdf(y_train_file)

print('Reading y_test')
y_test_file = os.path.join(path, 'y_lichen_twice_test.hdf')
