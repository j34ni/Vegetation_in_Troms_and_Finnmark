...
print('Input files')
path = '/opt/uio/data/'
x_filename = 'x_tps_once_2*.hdf'
file_list = glob.glob(os.path.join(path, x_filename))
file_list.sort()
file_list

input_filename = os.path.join(path, 'input_tps_once.csv')
...
# Output to .csv
print('Output files')
y_filename = 'y_once_2*.hdf'
file_list = glob.glob(os.path.join(path, y_filename))
file_list.sort()
file_list

output_filename = os.path.join(path, 'output_once.csv')
