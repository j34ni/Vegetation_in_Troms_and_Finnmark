...
print('Input files')
path = '/opt/uio/data/'
x_filename = 'x_tp_twice_2*.hdf'
file_list = glob.glob(os.path.join(path, x_filename))
file_list.sort()
file_list

input_filename = os.path.join(path, 'input_tp_twice.csv')
...
# Output to .csv
print('Output files')
y_filename = 'y_twice_2*.hdf'
file_list = glob.glob(os.path.join(path, y_filename))
file_list.sort()
file_list

output_filename = os.path.join(path, 'output_twice.csv')
